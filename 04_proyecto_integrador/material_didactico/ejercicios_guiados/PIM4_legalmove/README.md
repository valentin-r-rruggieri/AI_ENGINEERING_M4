...
```bash
python3 04_proyecto_integrador/material_didactico/ejercicios_guiados/PIM4_legalmove/e01_comparador_basico_vs_agentes.py
python3 04_proyecto_integrador/material_didactico/ejercicios_guiados/PIM4_legalmove/e02_output_libre_vs_pydantic.py
python3 04_proyecto_integrador/material_didactico/ejercicios_guiados/PIM4_legalmove/e03_sin_logs_vs_langfuse.py
```

Modo con API real:

```bash
python3 04_proyecto_integrador/material_didactico/ejercicios_guiados/PIM4_legalmove/e01_comparador_basico_vs_agentes.py --real-api
python3 04_proyecto_integrador/material_didactico/ejercicios_guiados/PIM4_legalmove/e03_sin_logs_vs_langfuse.py --real-api --langfuse
```

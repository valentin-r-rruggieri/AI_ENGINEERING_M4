...
Estos notebooks no reemplazan los scripts Python de `02_python_puro/AEM4_python_exercises/AEM4L2_audio_pipelines/`. Funcionan como apoyo visual y modular para explicar conceptos antes de ejecutar los ejercicios con OpenAI real.

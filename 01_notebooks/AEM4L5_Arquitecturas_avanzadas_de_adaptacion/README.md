...
Después de explicar estos notebooks, usar los scripts de `02_python_puro/AEM4_python_exercises/AEM4L5_adaptacion_serving/` para llevar la teoría a casos ejecutables con OpenAI real:

# Hugging Face: arquitectura Transformer

```powershell
pip install -r 03_extras/L4_transformers/huggingface/requirements.txt
python 03_extras/L4_transformers/huggingface/00_transformers/00_pipeline_clasificacion.py
```

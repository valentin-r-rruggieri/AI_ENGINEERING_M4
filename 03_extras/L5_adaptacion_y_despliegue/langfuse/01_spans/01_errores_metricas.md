...
Hacer visible una falla y el uso de recursos asociado.
...
Abri primero langfuse\01_spans\01_errores_metricaspy. Los comentarios del archivo separan preparacion, calculo o llamada principal y salida. Ejecutalo antes de modificarlo: relaciona cada variable con una decision de adaptacion o despliegue.
...
Fuerza un error pedagogico y comprueba el estado en Langfuse.

...
Aplicar una regla explicable a carga, SLA y escalado a cero.
...
Abri primero arquitecturas_serving\02_en_marcha\seleccionar_arquitecturapy. Los comentarios del archivo separan preparacion, calculo o llamada principal y salida. Ejecutalo antes de modificarlo: relaciona cada variable con una decision de adaptacion o despliegue.
...
Prueba un SLA de 500 ms y explica el resultado.

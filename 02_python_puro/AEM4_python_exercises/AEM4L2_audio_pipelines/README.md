...
|---|---|
| Referencia humana vs transcripción ASR | `../../../01_notebooks/AEM4L2_Introduccion_a_audio_pipelines/notebooks/E01_resuelto_referencia_vs_asr.ipynb` |
| WER paso a paso | `../../../01_notebooks/AEM4L2_Introduccion_a_audio_pipelines/notebooks/E02_resuelto_wer_manual.ipynb` |
| Implementar WER como función reutilizable | `../../../01_notebooks/AEM4L2_Introduccion_a_audio_pipelines/notebooks/E03_resuelto_funcion_simple_wer.ipynb` |
| Transcripción a resumen y action items | `../../../01_notebooks/AEM4L2_Introduccion_a_audio_pipelines/notebooks/E04_resuelto_transcripcion_a_resumen_action_items.ipynb` |
| Práctica de dominio financiero | `../../../01_notebooks/AEM4L2_Introduccion_a_audio_pipelines/notebooks/E05_para_resolver_reclamo_bancario.ipynb` |
| Práctica de WER médico | `../../../01_notebooks/AEM4L2_Introduccion_a_audio_pipelines/notebooks/E06_para_resolver_wer_llamada_medica.ipynb` |
| Starter visual para detectar errores | `../../../01_notebooks/AEM4L2_Introduccion_a_audio_pipelines/notebooks/E07_inicial_detectar_errores_transcripcion.ipynb` |
| Pipeline evaluado completo | `../../../01_notebooks/AEM4L2_Introduccion_a_audio_pipelines/notebooks/E08_avanzado_audio_pipeline_evaluado.ipynb` |

...
```bash
cd /Users/valentin/AI_ENGINEERING_M4/02_python_puro/AEM4_python_exercises
...
```json
{
  "mcpServers": {
    "aem4l3-github": {
      ...
      "args": [
        "/Users/valentin/AI_ENGINEERING_M4/02_python_puro/AEM4_python_exercises/AEM4L3_mcp/e01_github_mcp_server.py"
      ],
      "env": {
        "GITHUB_TOKEN": "ghp_..."
      }
...
```json
{
  "mcpServers": {
    "aem4l3-github": {
      ...
      "args": [
        "C:/Users/Usuario/Desktop/Clases/AI_ENGINEERING_M4/02_python_puro/AEM4_python_exercises/AEM4L3_mcp/e01_github_mcp_server.py"
      ],
      "env": {
        "GITHUB_TOKEN": "ghp_..."
      }
...
```json
{
  "servers": {
    "aem4l3Github": {
      ...
      "command": "/Users/valentin/AI_ENGINEERING_M4/.venv/bin/python",
      "args": [
        "${workspaceFolder}/02_python_puro/AEM4_python_exercises/AEM4L3_mcp/e01_github_mcp_server.py"
      ],
      "envFile": "${workspaceFolder}/02_python_puro/AEM4_python_exercises/.env"
    }
  }
}
```

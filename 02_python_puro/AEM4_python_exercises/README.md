...
```
02_python_puro/AEM4_python_exercises/
...
El proyecto integrador vive separado en `04_proyecto_integrador/PIM4_legalmove/` para que no se mezcle con los ejercicios de clase.
...
```bash
python 02_python_puro/AEM4_python_exercises/AEM4L1_vision_imagenes/e01_vision_descripcion_basica.py
```

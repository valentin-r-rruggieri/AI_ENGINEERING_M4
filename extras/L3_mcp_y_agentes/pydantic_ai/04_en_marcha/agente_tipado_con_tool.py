...
if os.getenv("OPENAI_API_KEY"):
    ...
    # Produce el mismo contrato con un cálculo local y visible.
    salida = CambioPlazo(diferencia_meses=calcular_diferencia(12, 18), confianza=1.0)
    print("Falta OPENAI_API_KEY. Resultado local:", salida.model_dump())

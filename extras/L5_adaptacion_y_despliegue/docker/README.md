...
```powershell
pip install -r extras/L5_adaptacion_y_despliegue/docker/requirements.txt
docker build -f extras/L5_adaptacion_y_despliegue/docker/02_en_marcha/Dockerfile -t aem4-fastapi extras/L5_adaptacion_y_despliegue/docker

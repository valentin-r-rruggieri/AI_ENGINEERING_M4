...
```powershell
pip install -r extras/L5_adaptacion_y_despliegue/huggingface_lora/requirements.txt
python extras/L5_adaptacion_y_despliegue/huggingface_lora/00_entrenamiento/00_trainer_cpu.py
```
